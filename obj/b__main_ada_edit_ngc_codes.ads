...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_edit_ngc_codes" & ASCII.NUL;
   ...
   u00167 : constant Version_32 := 16#1a72532b#;
   pragma Export (C, u00167, "pkg_ada_datetime_stampB");
   u00168 : constant Version_32 := 16#4dd244a1#;
   ...
   u00212 : constant Version_32 := 16#2323a8af#;
   pragma Export (C, u00212, "system__memoryB");
   u00213 : constant Version_32 := 16#1f488a30#;
